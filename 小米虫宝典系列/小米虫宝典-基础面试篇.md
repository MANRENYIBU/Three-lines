...
本笔记收录`米虫`后端技术栈的相关知识，分为知识篇、面试篇、拷打篇。本篇为`面试篇`。
...
![image-20250222212853898](./img/小米虫宝典-基础面试篇-img/image-20250222212853898.png)
...
![image-20250222220559343](./img/小米虫宝典-基础面试篇-img/image-20250222220559343.png)
...
![image-20250222223055089](./img/小米虫宝典-基础面试篇-img/image-20250222223055089.png)
...
![image-20250222223340015](./img/小米虫宝典-基础面试篇-img/image-20250222223340015.png)

总结一下就是私有化变量，然后不要暴露 set 方法，即使有修改的需求也是返回一个新对象。

### Java 中 Exception 和 Error 有什么区别?

![image-20250222230925932](./img/小米虫宝典-基础面试篇-img/image-20250222230925932.png)
...
![image-20250222225644510](./img/小米虫宝典-基础面试篇-img/image-20250222225644510.png)
...
![image-20250223171554212](./img/小米虫宝典-基础面试篇-img/image-20250223171554212.png)
...
![image-20250223174447861](./img/小米虫宝典-基础面试篇-img/image-20250223174447861.png)
...
![image-20250223174936326](./img/小米虫宝典-基础面试篇-img/image-20250223174936326.png)
...
![image-20250224004001220](./img/小米虫宝典-基础面试篇-img/image-20250224004001220.png)

回答重点提到了 char 数组，这里可能会被面试官插入问:String 底层不也是用的 char 数组存放吗?**两者有啥区别**?

![image-20250224004109600](./img/小米虫宝典-基础面试篇-img/image-20250224004109600.png)
...
![image-20250224004336053](./img/小米虫宝典-基础面试篇-img/image-20250224004336053.png)

这里一定要点破:数组是连续内存的结构，并且要体现出你有节省内存和提高效率的意识，熟悉 HashMap 的同学对这类操作应该很有经验。

我们来看下调用 `AbstractStringBuilder` 这个父类的构造器。

![image-20250224004641204](./img/小米虫宝典-基础面试篇-img/image-20250224004641204.png)

可以看到，就是直接 new 申请数组没啥花头。

我们来看下 append 操作。

![image-20250224004716984](./img/小米虫宝典-基础面试篇-img/image-20250224004716984.png)

可以看到 `append` 有多个实现，毕竟我们平日啥都类型都直接 `append` ，那底层是怎么实现这些类型转换的呢?

我们拿 `append(int)` 来举个例子，其他类型本质都是一样的。

![image-20250224004755482](./img/小米虫宝典-基础面试篇-img/image-20250224004755482.png)
...
![image-20250224005147408](./img/小米虫宝典-基础面试篇-img/image-20250224005147408.png)
...
![image-20250224005406708](./img/小米虫宝典-基础面试篇-img/image-20250224005406708.png)
...
![image-20250224005641797](./img/小米虫宝典-基础面试篇-img/image-20250224005641797.png)

身为底层实现，还是很细的，可以仔细看下上面的逻辑，位运算看不懂没事，注释已经把原有的公式写出来的，对照着看看，还是能理解的，这里我就不再赘述了。

然后各位也应该注意到上面的数字、数字十这两个数组了，没错还是熟悉的查表法!

![image-20250224011013916](./img/小米虫宝典-基础面试篇-img/image-20250224011013916.png)
...
![image-20250224011129995](./img/小米虫宝典-基础面试篇-img/image-20250224011129995.png)

好了，这波操作下来，想必拨开了很多对`StringBuilder`的迷雾吧~

再来看看 insert，我们还是拿int的插入来举例：

![image-20250224011224896](./img/小米虫宝典-基础面试篇-img/image-20250224011224896.png)

可以看到，这里是把 int 转成 string 了，然后调用以下的方法。

![image-20250224011313436](./img/小米虫宝典-基础面试篇-img/image-20250224011313436.png)
...
![image-20250224011746297](./img/小米虫宝典-基础面试篇-img/image-20250224011746297.png)
...
![image-20250224012243522](./img/小米虫宝典-基础面试篇-img/image-20250224012243522.png)

再看下 append 的方法的实现:

![image-20250224012300774](./img/小米虫宝典-基础面试篇-img/image-20250224012300774.png)
...
![image-20250224170631541](./img/小米虫宝典-基础面试篇-img/image-20250224170631541.png)
...
![image-20250224171145852](./img/小米虫宝典-基础面试篇-img/image-20250224171145852.png)
...
![image-20250224205700384](./img/小米虫宝典-基础面试篇-img/image-20250224205700384.png)

equals，我们知道是用来判断两个对象是否相同的，也是属于 Object 的一个方法，并且默认实现如下:

![image-20250224205721432](./img/小米虫宝典-基础面试篇-img/image-20250224205721432.png)
...
![image-20250224210045468](./img/小米虫宝典-基础面试篇-img/image-20250224210045468.png)

然后在具体执行 `putVal` 方法的时候，相关的判断条件会**先判断 hash 值是否相等**，如果 hash 值都不同，**那就认为这两个对象不相等**，这与我们之前设定的 name 一样的对象就是相等的条件就冲突了，我们简单看下源码就清楚了:

![image-20250224210302783](./img/小米虫宝典-基础面试篇-img/image-20250224210302783.png)
...
![image-20250224213343302](./img/小米虫宝典-基础面试篇-img/image-20250224213343302.png)

再深一点点就是代理类会现在静态块中通过反射把所有方法都拿到存在静态变量中，我之前反编译看过代理类，我盲写了一下，大致长这样:

![image-20250224213452112](./img/小米虫宝典-基础面试篇-img/image-20250224213452112.png)
...
![image-20250224224012031](./img/小米虫宝典-基础面试篇-img/image-20250224224012031.png)
...
![image-20250224224050989](./img/小米虫宝典-基础面试篇-img/image-20250224224050989.png)
...
![image-20250224235918882](./img/小米虫宝典-基础面试篇-img/image-20250224235918882.png)

如果一不小心取错类型，终编译的时候能过，但是运行的时候却抛错。

![image-20250224235944579](./img/小米虫宝典-基础面试篇-img/image-20250224235944579.png)
...
![image-20250225000031213](./img/小米虫宝典-基础面试篇-img/image-20250225000031213.png)

并且也不需要在代码上显示的强转，从以下代码可以看出，能直接获取 String 类型元素。

![image-20250225000055477](./img/小米虫宝典-基础面试篇-img/image-20250225000055477.png)
...
![image-20250225001049769](./img/小米虫宝典-基础面试篇-img/image-20250225001049769.png)
...
![image-20250225002612017](./img/小米虫宝典-基础面试篇-img/image-20250225002612017.png)

上述定义了泛型类型为 String 的 list，并且获取的 str 不需要强转，这一步是怎么做的呢?

`javap -c` 看下字节码:

![image-20250225002644312](./img/小米虫宝典-基础面试篇-img/image-20250225002644312.png)
...
![image-20250225003102344](./img/小米虫宝典-基础面试篇-img/image-20250225003102344.png)

通过反射，我确实获得了 list 的类型。那既然类型被擦除了，这又是怎么做到的呢?

我们直接进行一手 `javap -v`，反编译看到字节码里面有这样的记录:

![image-20250225003224938](./img/小米虫宝典-基础面试篇-img/image-20250225003224938.png)
...
![image-20250303004210635](./img/小米虫宝典-基础面试篇-img/image-20250303004210635.png)
...
![image-20250303180110635](./img/小米虫宝典-基础面试篇-img/image-20250303180110635.png)
...
![image-20250303180340933](./img/小米虫宝典-基础面试篇-img/image-20250303180340933.png)
...
![image-20250303190723160](./img/小米虫宝典-基础面试篇-img/image-20250303190723160.png)
...
![image-20250303190906370](./img/小米虫宝典-基础面试篇-img/image-20250303190906370.png)
...
![image-20250303191148144](./img/小米虫宝典-基础面试篇-img/image-20250303191148144.png)
...
![image-20250303192144559](./img/小米虫宝典-基础面试篇-img/image-20250303192144559.png)
...
![image-20250303192455167](./img/小米虫宝典-基础面试篇-img/image-20250303192455167.png)
...
![image-20250303195215110](./img/小米虫宝典-基础面试篇-img/image-20250303195215110.png)
...
![image-20250304211126505](./img/小米虫宝典-基础面试篇-img/image-20250304211126505.png)
...
![image-20250304211252833](./img/小米虫宝典-基础面试篇-img/image-20250304211252833.png)
...
![image-20250304224413592](./img/小米虫宝典-基础面试篇-img/image-20250304224413592.png)
...
![image-20250304230636159](./img/小米虫宝典-基础面试篇-img/image-20250304230636159.png)
...
![image-20250304231012896](./img/小米虫宝典-基础面试篇-img/image-20250304231012896.png)

这样看来orElse确实性能会差，奇怪了，难道是bug?

我们来看下源码：

![image-20250304231112659](./img/小米虫宝典-基础面试篇-img/image-20250304231112659.png)
...
![image-20250305230736939](./img/小米虫宝典-基础面试篇-img/image-20250305230736939.png)
...
![20220219202800.png](./img/小米虫宝典-基础面试篇-img/20220219202800_mianshiya.png)
...
![20220219202845.png](./img/小米虫宝典-基础面试篇-img/20220219202845_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/pLwh6DJV_image_mianshiya.png)
...
![20220219202821.png](./img/小米虫宝典-基础面试篇-img/20220219202821_mianshiya.png)
...
![20220219202832.png](./img/小米虫宝典-基础面试篇-img/20220219202832_mianshiya.png)
...
- [9179. Java ArrayList 的扩容机制是什么？](https://www.mianshiya.com/question/1839515038747066370)
...
扩容是一个相对耗时的操作，因为需要分配新的内存并复制元素。频繁的扩容会影响性能，因此建议在创建 ArrayList 时**根据预期的元素数量设置合适的初始容量**。
...
最终通过 `Arrays.copyOf(elementData, newCapacity);` 复制老数组的数据到新数组，完成扩容。
...
![image-20250314124209719](./img/小米虫宝典-基础面试篇-img/image-20250314124209719.png)

hash算法是可能产生冲突的，且数组的大小是有限的，所以很可能通过不同的key计算得到一样的下标，因此为了解决键值对冲突的问题，采用了**链表法**，如下图所示：

![image-20250314124906228](./img/小米虫宝典-基础面试篇-img/image-20250314124906228.png)

在JDK1.7及之前链表的插入采用的是**头插法**，即每当发生哈希冲突时，**新的节点总是插入到链表的头部**，老节点依次向后移动，形成新的链表结构。

![image-20250314124939215](./img/小米虫宝典-基础面试篇-img/image-20250314124939215.png)
...
![image-20250314125324555](./img/小米虫宝典-基础面试篇-img/image-20250314125324555.png)
...
![image-20250314125652760](./img/小米虫宝典-基础面试篇-img/image-20250314125652760.png)
...
![image-20250314125721578](./img/小米虫宝典-基础面试篇-img/image-20250314125721578.png)
...
![image-20250314130614607](./img/小米虫宝典-基础面试篇-img/image-20250314130614607.png)
...
![image-20250314130713144](./img/小米虫宝典-基础面试篇-img/image-20250314130713144.png)

在JDK1.8的时候，改成了**尾插法**，即新的节点插入到链表的尾部，保持插入的顺序。并且引入了**红黑树**。

![image-20250314130735128](./img/小米虫宝典-基础面试篇-img/image-20250314130735128-1741928855499-1.png)

当链表的长度大于8且数组大小大于等于64的时候，就把链表转化成红黑树，当红黑树节点小于6的时候，又会退化成链表。

![image-20250314130817095](./img/小米虫宝典-基础面试篇-img/image-20250314130817095.png)
...
- 在 `add` 方法中，每次添加元素时，会加锁，首先创建了数组的副本 `newElements`，然后在这个副本中添加新元素。最后，将原数组 `elements` 替换为新副本 `newElements`。
...
在 `CopyOnWriteArrayList` 中，底层数据结构是一个 `volatile` 修饰的数组，当对列表进行写操作时，操作步骤如下：
...
![image.png](./img/小米虫宝典-基础面试篇-img/RHfGHdEF_image_mianshiya.png)
...
![image-20250313223001225](./img/小米虫宝典-基础面试篇-img/image-20250313223001225.png)
...
![img](./img/小米虫宝典-基础面试篇-img/IzQdlrA8_20b7c330-9493-4ce7-8a8a-2e6713e00ac1_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/9ksKxXIh_image_mianshiya.png)

`treeifyBin` 内还需判断数组的大小：

![image.png](./img/小米虫宝典-基础面试篇-img/neWKcf70_image_mianshiya.png)
...
![20220219202947.png](./img/小米虫宝典-基础面试篇-img/20220219202947.png)

因为**红黑树节点的大小是普通节点大小的两倍**，所以为了节省内存空间不会直接只用红黑树，只有当节点到达一定数量才会转成红黑树，这里定义的是 8。

为什么是 8 呢？这个其实 HashMap 注释上也有说，和泊松分布有关系。

![20220219202956.png](./img/小米虫宝典-基础面试篇-img/20220219202956_mianshiya.png)
...
![image-20250314231851368](./img/小米虫宝典-基础面试篇-img/image-20250314231851368.png)
...
![image-20250314234555461](./img/小米虫宝典-基础面试篇-img/image-20250314234555461.png)
...
![image-20250314234645291](./img/小米虫宝典-基础面试篇-img/image-20250314234645291.png)
...
![image-20250314234846157](./img/小米虫宝典-基础面试篇-img/image-20250314234846157.png)
...
![image-20250314235516154](./img/小米虫宝典-基础面试篇-img/image-20250314235516154.png)
...
![image-20250315000730887](./img/小米虫宝典-基础面试篇-img/image-20250315000730887.png)

在put的时候，就会通过`addCount`方法维护`counterCells`的数量，当然remove的时候也会调用此方法。

![image-20250315000806138](./img/小米虫宝典-基础面试篇-img/image-20250315000806138.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/ndrY3lLs_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/snEDo77X_image_mianshiya.png)

##### 再哈希法（双重哈希）

在出现碰撞时，使用第二个哈希函数计算新的索引位置，减少碰撞的概率

![image.png](./img/小米虫宝典-基础面试篇-img/3A87Qnvx_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/lctBikgm_image_mianshiya.png)

主要的定位逻辑在 `e = tabAt(tab, (n - 1) & h)) != null` 这行。

而 tabAt 内部使用的就是`Unsafe#getObjectVolatile`来保证可见性。

![image.png](./img/小米虫宝典-基础面试篇-img/aIl2YPR8_image_mianshiya.png)

`getObjectVolatile` 实际是一个 native 方法，即本地方法，通过 JNI（Java Native Interface）调用底层的 C++ 实现。

![image.png](./img/小米虫宝典-基础面试篇-img/8zT0Nnmz_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/gsndtATm_image_mianshiya.png)
...
![image-20250307222232971](./img/小米虫宝典-基础面试篇-img/image-20250307222232971.png)

##### 添加元素

在添加元素的时候，会利用`ReentrantLock`上锁，实现添加元素的并发安全：

![image-20250307225432356](./img/小米虫宝典-基础面试篇-img/image-20250307225432356.png)
...
![image-20250307230341190](./img/小米虫宝典-基础面试篇-img/image-20250307230341190.png)
...
![image-20250307230608779](./img/小米虫宝典-基础面试篇-img/image-20250307230608779.png)
...
![image-20250307230759221](./img/小米虫宝典-基础面试篇-img/image-20250307230759221.png)
...
![image-20250307231103549](./img/小米虫宝典-基础面试篇-img/image-20250307231103549.png)

核心线程数**已满**，任务队列**未满**的情况：

![image-20250307231124308](./img/小米虫宝典-基础面试篇-img/image-20250307231124308.png)

核心线程数**已满**，任务队列**已满**的情况：

![image-20250307231140875](./img/小米虫宝典-基础面试篇-img/image-20250307231140875.png)

线程池中线程数已达**最大线程数**的情况：

![image-20250307231159533](./img/小米虫宝典-基础面试篇-img/image-20250307231159533.png)
...
![image-20250307231332999](./img/小米虫宝典-基础面试篇-img/image-20250307231332999.png)

不过，可以通过`setPrestartAllCoreThreads`将其改为 true。

![image-20250307231351934](./img/小米虫宝典-基础面试篇-img/image-20250307231351934.png)

##### processWorkerExit 源码

可以看到，根据`allowCoreThreadTimeOut`参数，实际可以控制线程池的最小线程数，使得**核心线程数也可以被销毁**。

![image-20250307231513567](./img/小米虫宝典-基础面试篇-img/image-20250307231513567.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/l23lmXWq_image_mianshiya.png)
...
![image-20250313221341502](./img/小米虫宝典-基础面试篇-img/image-20250313221341502.png)
...
![image-20250313221653154](./img/小米虫宝典-基础面试篇-img/image-20250313221653154.png)
...
![image-20250308142920517](./img/小米虫宝典-基础面试篇-img/image-20250308142920517.png)
...
![image-20250308144547769](./img/小米虫宝典-基础面试篇-img/image-20250308144547769.png)

在内部CAS中，添加了版本号的对比：

![image-20250308144702107](./img/小米虫宝典-基础面试篇-img/image-20250308144702107.png)
...
![image-20250308144752455](./img/小米虫宝典-基础面试篇-img/image-20250308144752455.png)
...
![image-20250308145005439](./img/小米虫宝典-基础面试篇-img/image-20250308145005439.png)
...
![image-20250308145225307](./img/小米虫宝典-基础面试篇-img/image-20250308145225307.png)
...
![image-20250308150025276](./img/小米虫宝典-基础面试篇-img/image-20250308150025276.png)
...
![image-20250308153118868](./img/小米虫宝典-基础面试篇-img/image-20250308153118868.png)
...
![image-20250308153249005](./img/小米虫宝典-基础面试篇-img/image-20250308153249005.png)

再看下`ReentrantLock`强制加锁，如果未抢到则入队的过程：

![image-20250308154050367](./img/小米虫宝典-基础面试篇-img/image-20250308154050367.png)

这里需要先看下acquireQueued方法:

![image-20250308154136131](./img/小米虫宝典-基础面试篇-img/image-20250308154136131.png)
...
![image-20250308154923698](./img/小米虫宝典-基础面试篇-img/image-20250308154923698.png)
...
![image-20250308182517203](./img/小米虫宝典-基础面试篇-img/image-20250308182517203.png)
...
![image-20250308184106888](./img/小米虫宝典-基础面试篇-img/image-20250308184106888.png)

且前面线程如果等待超时或者主动取消后，需要从队列中移除，且后面的线程需要“顶”上来。

![image-20250308184138339](./img/小米虫宝典-基础面试篇-img/image-20250308184138339.png)
...
![image-20250308193139164](./img/小米虫宝典-基础面试篇-img/image-20250308193139164.png)
...
![image-20250308193726403](./img/小米虫宝典-基础面试篇-img/image-20250308193726403.png)
...
![image-20250308194017893](./img/小米虫宝典-基础面试篇-img/image-20250308194017893.png)
...
![image-20250308194422567](./img/小米虫宝典-基础面试篇-img/image-20250308194422567.png)

我再画一下64位时`MarkWord`在不同状态下的内存布局

![image-20250308194510798](./img/小米虫宝典-基础面试篇-img/image-20250308194510798.png)
...
![image-20250308194836714](./img/小米虫宝典-基础面试篇-img/image-20250308194836714.png)

而这个`monitor`在HotSpot中是c++实现的，叫`ObjectMonitor`，**它是管程的实现，也有叫监视器的**。

它长这样，重点字段我都注释了含义，还专门截了个头文件的注释：

![image-20250308194912987](./img/小米虫宝典-基础面试篇-img/image-20250308194912987.png)
...
![image-20250308222550866](./img/小米虫宝典-基础面试篇-img/image-20250308222550866.png)

好，我们继续。

前面我们提到了`monitorenter`这个指令，这个指令会执行下面的代码：

![image-20250308222856874](./img/小米虫宝典-基础面试篇-img/image-20250308222856874.png)

我们现在分析的是重量级锁，所以不关心偏向的代码，而slow_enter方法文章一开始的截图就是了，最终会执行到`ObjectMonitor::enter`这个方法中。

![image-20250308223044296](./img/小米虫宝典-基础面试篇-img/image-20250308223044296.png)
...
![image-20250308223417158](./img/小米虫宝典-基础面试篇-img/image-20250308223417158.png)
...
![image-20250308223822513](./img/小米虫宝典-基础面试篇-img/image-20250308223822513.png)

可以看到不论哪个分支都会执行`Self->_ParkEvent->park()`，这个就是上文提到的调用`pthread_mutex_lock`。

至此争抢锁的流程已经很清晰了，我再画个图来理一理。

![image-20250308223918552](./img/小米虫宝典-基础面试篇-img/image-20250308223918552.png)

`ObjectMonitor::exit`就是解锁时会调用的方法。

![image-20250308224404710](./img/小米虫宝典-基础面试篇-img/image-20250308224404710.png)
...
![image-20250308224540597](./img/小米虫宝典-基础面试篇-img/image-20250308224540597.png)

如果`QMode == 3 &&_cxq!= NULL`的时候，我就截取了一部分代码：

![image-20250308224615387](./img/小米虫宝典-基础面试篇-img/image-20250308224615387.png)

如果`QMode == 4 && _cxq != NULL`的时候:

![image-20250308224648873](./img/小米虫宝典-基础面试篇-img/image-20250308224648873.png)

如果QMode不是2的话，最终会执行：

![image-20250308224724565](./img/小米虫宝典-基础面试篇-img/image-20250308224724565.png)

至此，解锁的流程就完毕了！我再画一波流程图：

![image-20250308224743894](./img/小米虫宝典-基础面试篇-img/image-20250308224743894.png)
...
![image-20250308230515779](./img/小米虫宝典-基础面试篇-img/image-20250308230515779.png)
...
![image-20250308231713475](./img/小米虫宝典-基础面试篇-img/image-20250308231713475.png)
...
![image-20250308232101700](./img/小米虫宝典-基础面试篇-img/image-20250308232101700.png)
...
![image-20250308232611453](./img/小米虫宝典-基础面试篇-img/image-20250308232611453.png)

包括期间的一些细节应该也较为清楚了，我觉得对于Synchronized了解到这份上差不多了。

我再搞了张`openjdk wiki`上的图，看看是不是很清晰了：

![image-20250308232638314](./img/小米虫宝典-基础面试篇-img/image-20250308232638314.png)
...
![image-20250309162512563](./img/小米虫宝典-基础面试篇-img/image-20250309162512563.png)
...
**Java内存模型(JavaMemoryModel,JMM)是Java虚拟机(JVM)定义的一种规范**，用于描述**多线程程序中变量(包括实例字段、静态字段和数组元素）如何在内存中存储和传递的规则**。规范了线程何时会从主内存中读取数据、何时会把数据写回主内存。
...
![image-20250310230440349](./img/小米虫宝典-基础面试篇-img/image-20250310230440349.png)
...
![image-20250310230459774](./img/小米虫宝典-基础面试篇-img/image-20250310230459774.png)
...
![image-20250310230759160](./img/小米虫宝典-基础面试篇-img/image-20250310230759160.png)
...
![image-20250311003217965](./img/小米虫宝典-基础面试篇-img/image-20250311003217965.png)
...
![image-20250311003554577](./img/小米虫宝典-基础面试篇-img/image-20250311003554577.png)
...
![image-20250311003739270](./img/小米虫宝典-基础面试篇-img/image-20250311003739270.png)
...
![image-20250311003958336](./img/小米虫宝典-基础面试篇-img/image-20250311003958336.png)
...
![image-20250311004304404](./img/小米虫宝典-基础面试篇-img/image-20250311004304404.png)
...
![image-20250312140034004](./img/小米虫宝典-基础面试篇-img/image-20250312140034004.png)
...
![image-20250312140717214](./img/小米虫宝典-基础面试篇-img/image-20250312140717214.png)
...
![image-20250312141750124](./img/小米虫宝典-基础面试篇-img/image-20250312141750124.png)
...
1. 在构造函数内对一个 final 域的写入，与随后把这个被构造对象的引用赋值给一个引用变量，这两个操作之间不能重排序。（这样可以保证 final 域在对象被其他线程可见前，已经被正确初始化）
...
>对于 final 修饰的变量，构造方法执行完毕后，其他线程一定能看到正确的 final 变量值。 但如果 final 变量指向的是一个可变对象（如 List），那么 final 仅能保证引用的可见性，不能保证对象内部状态的可见性。 如果要保证对象内部状态的可见性，需要使用 volatile 或 synchronized。
...
![image.png](./img/小米虫宝典-基础面试篇-img/AiNnhu94_image_mianshiya.png)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136353330372e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136353330372e706e67_mianshiya.png)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136353331362e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136353331362e706e67_mianshiya.png)
...
**`Thread.sleep()` 与 `Thread.yield()` 的底层机制**：
...
- [516.Java 中 Thread.sleep(0) 的作用是什么？](https://www.mianshiya.com/question/1780933295102521345)
...
![image.png](./img/小米虫宝典-面试篇-img/OdNovYUz_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/PIqFm0JJ_image_mianshiya.png)

任务执行逻辑就是 `task.run()` ，可以看到它被 `try catch finally`包裹，异常被扔到了 `afterExecute` 中，并且也继续被抛了出来。

而这一层外面，还有个`try  finally`，所以异常的抛出打破了 while 循环，最终会执行 `processWorkerExit` 方法。

我们来看下这个方法，其实逻辑很简单，**把这个线程废了，然后新建一个线程替换之**。

![image.png](./img/小米虫宝典-基础面试篇-img/S7Tw0JRF_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/jjOYQ4AW_image_mianshiya.png)

那么 `submit` 也调用了 `execute` 为什么不会创建新线程呢？

门道就在 `RunnableFuture`，从下面代码可以看到 `RunnableFuture` 的实现类 `FutureTask` 中的 run 方法有个`setException(ex);` 逻辑，就是它把异常给 catch 住了，没有继续往上抛，所以没有触发移除线程和新建线程的操作。

![image.png](./img/小米虫宝典-基础面试篇-img/GIgvK48J_image_mianshiya.png)
...
- **CPU飙升风险**：如果线程使用 `writeLock()` 或者`readLock()` 获得锁之后，线程还没执行完就被 `interrupt()` 的话，会导致CPU飙升，需要用 `readLockInterruptibly` 或者 `writeLockInterruptibly` 。

[CPU 飙升示例代码](http://ifeve.com/stampedlock-bug-cpu)

我本地跑了下复现了：

![pic.jpg](./img/小米虫宝典-基础面试篇-img/6Eag6VXp_pic_mianshiya.jpg)
...
```java
▼java复制代码import java.util.concurrent.locks.StampedLock;
...
- **写锁**用于修改共享资源，多个线程无法同时持有写锁。
- **悲观读锁**保证数据一致性，适合写操作较多的场景。
- **乐观读锁**适用于读多写少的场景，可以在大部分时间无锁读取，大大提高性能。
...
##### **`LongAdder` 和 `DoubleAdder` 的工作原理**

- `LongAdder` 和 `DoubleAdder` 通过维护多个 `Cell` 实例（每个 `Cell` 实际上是一个 `AtomicLong` 或 `AtomicDouble`）来实现并发累加操作。每个线程会选择不同的 `Cell` 来更新，这样可以减少锁的竞争。
...
![image-20250315162913212](./img/小米虫宝典-基础面试篇-img/image-20250315162913212.png)

**清除不会移动和整理内存空间**，一般都是通过空闲链表（双向链表）来标记哪一块内存空闲可用，因此会导致一个情况：**空间碎片**。

这会使得明明总的内存是够的，但是申请内存就是不足。

![image-20250315163004521](./img/小米虫宝典-基础面试篇-img/image-20250315163004521.png)

而且在申请内存的时候也有点麻烦，需要**遍历链表查找合适的内存块**，**会比较耗时**。

所以会有**多个空闲链表的实现**，也就是根据内存分块大小组成不同的链表，比如分为**大分块链表和小分块链表**，这样根据申请的内存分块大小遍历不同的链表，加快申请的效率。

![image-20250315163144441](./img/小米虫宝典-基础面试篇-img/image-20250315163144441.png)
...
![image-20250315163435021](./img/小米虫宝典-基础面试篇-img/image-20250315163435021.png)
...
![image-20250315163705056](./img/小米虫宝典-基础面试篇-img/image-20250315163705056.png)
...
![image-20250315164012329](./img/小米虫宝典-基础面试篇-img/image-20250315164012329.png)
...
JVM的主要组成部分包括**类加载器子系统(ClassLoader)**、**运行时数据区(Runtime Data Area)**、**执行引擎(Execution Engine)**以及**本地方法接口(Native Interface, JNI)**。

![image-20250315171240218](./img/小米虫宝典-基础面试篇-img/image-20250315171240218.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/3bzFOHV8_image_mianshiya.png)
...
![Snipaste_2024-05-02_21-04-13.jpg](./img/小米虫宝典-基础面试篇-img/Snipaste_2024-05-02_21-04-13_mianshiya.jpg)

###### 2. ParNew 收集器

它是 Serial 收集器的多线程版本，可以使用多条线程进行垃圾回收：

![Snipaste_2024-05-02_21-05-06.jpg](./img/小米虫宝典-基础面试篇-img/Snipaste_2024-05-02_21-05-06_mianshiya.jpg)
...
![Snipaste_2024-05-02_21-06-38.jpg](./img/小米虫宝典-基础面试篇-img/Snipaste_2024-05-02_21-06-38_mianshiya.jpg)

###### 5. Parallel Old 收集器

Parallel Old 是 Parallel Scavenge 收集器的老年代版本，支持多线程并发收集，采用 **标记-整理** 算法实现：

![Snipaste_2024-05-02_21-08-38.jpg](./img/小米虫宝典-基础面试篇-img/Snipaste_2024-05-02_21-08-38_mianshiya.jpg)
...
![Snipaste_2024-05-02_21-10-28.jpg](./img/小米虫宝典-基础面试篇-img/Snipaste_2024-05-02_21-10-28_mianshiya.jpg)
...
![zongjie-e0f5da26-6e46-4f9d-bfcc-0842cc7079e7.png](./img/小米虫宝典-基础面试篇-img/zongjie-e0f5da26-6e46-4f9d-bfcc-0842cc7079e7_mianshiya.png)
...
![Snipaste_2024-05-02_21-14-27.jpg](./img/小米虫宝典-基础面试篇-img/Snipaste_2024-05-02_21-14-27_mianshiya.jpg)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333431332e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333431332e706e67_mianshiya.png)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333531312e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333531312e706e67_mianshiya.png)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333532382e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333532382e706e67_mianshiya.png)

可以看到 TLAB 内部只剩一格大小，申请的对象需要两格，这时候需要再申请一块 TLAB ，之前的那一格就浪费了。

在 HotSpot 中会生成一个填充对象来填满这一块，因为堆需要**线性遍历**，遍历的流程是通过对象头得知对象的大小，然后跳过这个大小就能找到下一个对象，所以不能有空洞。
...
![img](./img/小米虫宝典-面试篇-img/dEhYOWNf_35fca68e-d2c6-4c22-be0d-53a23c428b0b_mianshiya.png)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303330373130313632373731322e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303330373130313632373731322e706e67_mianshiya.png)

还有一个**直接内存（Direct Memory）** 这里也提一下，它属于 JVM 之外的内存区域：
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303232383131323634333133352e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303232383131323634333133352e706e67_mianshiya.png)

> 简单翻译下就是：与软引用和弱引用不同，虚引用在排队时不会被垃圾回收器自动清除。通过虚引用可访问的对象将保持这种状态，直到所有这些引用被清除或者它们本身变得不可访问。

简单的说就是被虚引用引用的对象不能被 gc，然而在 JDK9 又有个变更记录：

![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303232383131323730323538322e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303232383131323730323538322e706e67_mianshiya.png)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303232383131323732343135382e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f696d6167652d32303231303232383131323732343135382e706e67_mianshiya.png)
...
- 常量池主要**用于减少重复对象的创建，节省内存并提高效率**。在 Java 编译过程中，一些常用的常量值如字符串、基本类型等会存储在常量池中，避免重复创建相同的常量。
...
- **使用 `new` 关键字**：`String s = new String("Hello");` 不论常量池中是否已存在`"Hello"`，都会在堆中创建一个新的 `String` 对象。
...
![企业微信截图_fd863e4d-646b-4b69-8c91-ead9144b9f07.png](./img/小米虫宝典-基础面试篇-img/nWAagDCv_fd863e4d-646b-4b69-8c91-ead9144b9f07_mianshiya.png)
...
![img](./img/小米虫宝典-基础面试篇-img/WH5ikKlS_307e24c7-83be-4597-a181-011224aa7b34_mianshiya.png)
...
![img](./img/小米虫宝典-基础面试篇-img/W8ylN5Ac_78f53bd2-1515-4dc7-8d17-ff727829a223_mianshiya.png)
...
![企业微信截图_356498bd-8c60-4b0e-b599-999b047d4376.png](./img/小米虫宝典-基础面试篇-img/JsOSPBN2_356498bd-8c60-4b0e-b599-999b047d4376_mianshiya.png)

在平台和应用类加载器受到加载请求时，会先判断该类是否属于一个系统模块，如果属于则委派给对应的模块类加载器加载，反之才委派给父类加载器。

JDK9 之后类加载器负责模块（图来自网络）：

![企业微信截图_c43e2b11-4eb9-4a0f-b07b-4326341a1b6e.png](./img/小米虫宝典-基础面试篇-img/7eFjm18m_c43e2b11-4eb9-4a0f-b07b-4326341a1b6e_mianshiya.png)

![企业微信截图_a2c32e43-ee8a-42cc-a07d-52ccc862fc85.png](./img/小米虫宝典-基础面试篇-img/rXCGcXjj_a2c32e43-ee8a-42cc-a07d-52ccc862fc85_mianshiya.png)

![企业微信截图_eab6eed5-fc23-462b-9e0d-6dd3c2131ec7.png](./img/小米虫宝典-基础面试篇-img/5fXoFl9v_eab6eed5-fc23-462b-9e0d-6dd3c2131ec7_mianshiya.png)
...
Java 中的 JIT（Just-In-Time，即时编译）编译器是一种**在程序运行时将字节码转换为机器码的技术**。因为这种转换是在程序运行时即时进行的，因此得名“Just-In-Time”。
...
JIT 编译器重点优化“热点代码”，即被**多次调用或循环执行的代码**。通过分析代码执行频率，JIT 能识别这些热点并进行优化编译。

这里的优化编译采用了多种技术：如**方法内联（Inlining）、逃逸分析（Escape Analysis）、循环展开（Loop Unrolling）等**，使得编译后的机器码更加高效。
...
[什么是 Java 的 AOT（Ahead-Of-Time）？](https://www.mianshiya.com/question/1780933295194796034)
...
- [529. 什么是 Java 中的 JIT（Just-In-Time）?](https://www.mianshiya.com/question/1780933295194796033)
...
逃逸分析（Escape Analysis）是 Java 编译器的优化技术，用于确定一个对象的作用范围，即分析对象是否会**逃逸**出当前方法或线程的作用范围。如果对象不会逃逸，JVM 可以实现栈上分配、同步消除、标量替换等优化，减少内存分配开销和同步开销，从而提高应用的性能。
...
在标量替换优化下，`Point` 对象可能不会被真正创建，`p.x` 和 `p.y` 会被替换为两个局部变量 `x` 和 `y`。
...
![image.png](./img/小米虫宝典-基础面试篇-img/EuEPHZgm_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/VqCahD6a_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/QgTRkTsI_image_mianshiya.png)

为了让图片更加清晰，我把步骤分开截图了，上图是 1-2 步骤，下图是 3-4 步骤。

![image.png](./img/小米虫宝典-基础面试篇-img/LMoOIHE0_image_mianshiya.png)

最终循环引用的 A 和 B 都能被清理，但是天下没有免费的午餐，最大的开销之一是**每个容器对象需要额外字段。**

还有**维护容器链表的开销**。根据 pybench，这个开销占了**大约 4% 的减速**。
...
- [538. Java 中有哪些垃圾回收算法？](https://www.mianshiya.com/question/1780933295236739074)
- [529. 什么是 Java 中的 JIT（Just-In-Time）?](https://www.mianshiya.com/question/1780933295194796033)
- [522. 编译执行与解释执行的区别是什么？JVM 使用哪种方式？](https://www.mianshiya.com/question/1780933295161241602)
...
![image.png](./img/小米虫宝典-基础面试篇-img/Tjxo6SFB_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/6v5xDiuq_image_mianshiya.png)
...
- [4683. 怎么分析 JVM 当前的内存占用情况？OOM 后怎么分析？](https://www.mianshiya.com/bank/1795650132375805954/question/1818990174270726145)
...
以下动图来自[维基百科](https://en.wikipedia.org/wiki/Tracing_garbage_collection)： ![image.png](./img/小米虫宝典-基础面试篇-img/Animation_of_tri-color_garbage_collection.gif)
...
1. **可并发执行**：垃圾回收器可以和程序同时工作，而不需要完全停止程序运行（只需要短暂的暂停）。
2. **避免误回收**：通过颜色标记，可以确保垃圾回收器不会回收那些还有其他房间钥匙指向的对象。
3. **效率高**：三色标记算法分阶段处理不同对象，避免了一次性全量检查的开销。
...
![image.png](./img/小米虫宝典-基础面试篇-img/EJd4TBMH_image_mianshiya.png)
...
利用写屏障在黑色引用白色对象时候，将白色对象置为灰色，这叫**增量更新。**

利用写屏障在灰色对象删除对白色对象的引用时，将白色对象置为灰，其实就是保存旧的引用关系。这叫**STAB（snapshot-at-the-beginning）**。
...
- [535. 为什么 Java 的垃圾收集器将堆分为老年代和新生代？](https://www.mianshiya.com/question/1780933295224156162)
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333535302e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333535302e706e67_mianshiya.png)
...
- [543. JVM 的 TLAB（Thread-Local Allocation Buffer）是什么？](https://www.mianshiya.com/question/1780933295253516289)

###  JVM 新生代垃圾回收如何避免全堆扫描？ 

#### 回答重点

JVM 在进行新生代垃圾回收时，通过以下方式**避免全堆扫描**：

1）**卡表（Card Table）机制**：JVM 使用卡表记录老年代引用新生代对象的指针变化，从而在进行新生代回收时，只扫描那些老年代中确实有引用指向新生代的区域，避免了全堆扫描。

2）**写屏障（Write Barrier）**：当老年代中的对象引用新生代对象时，写屏障会拦截这种引用，并在卡表中标记相关信息。这样，垃圾回收器在扫描时只需要检查标记的区域，而不是遍历整个新生代。
...
所以就搞了个叫记忆集（Remembered Set）的东西，来**记录跨代之间的引用而避免扫描整体非收集区域。**
...
拿对象精度来举例，假设新生代对象 A 被老年代对象 D 引用了，那么就需要记录老年代 D 所在的地址引用了新生代对象。

那卡的意思就是将内存空间分成很多卡片。假设新生代对象 A 被老年代 D 引用了，那么就需要记录老年代 D 所在的那一块内存片有引用新生代对象。

![image.png](./img/小米虫宝典-基础面试篇-img/IweiiYi2_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/laBZ4TI2_image_mianshiya.png)
...
还有一种**多卡表**，简单的说就是有多张卡表，这里我画两张卡表示意一下。

![image.png](./img/小米虫宝典-基础面试篇-img/tH5ryyXQ_image_mianshiya.png)
...
![image.png](./img/小米虫宝典-基础面试篇-img/mI8Tjai5_image_mianshiya.png)
...
即跨代引用问题，当触发young gc时，一些对象被老年代引用，young gc扫描不到，要扫描整个堆。 引入卡表，记录了老年代对于新生代对象的引用，只用扫描相关区域，避免了全堆扫描。但是有一定的延迟。
...
- [554. Java 的 CMS 垃圾回收流程是怎样的？](https://www.mianshiya.com/question/1780933295291265027)
- [553. Java 的 G1 垃圾回收流程是怎样的？](https://www.mianshiya.com/question/1780933295291265026)
- [549. Java 的 CMS 垃圾回收器和 G1 垃圾回收器在记忆集的维护上有什么不同？](https://www.mianshiya.com/question/1780933295274487811)
- [551. Java 中的 CMS 和 G1 垃圾收集器如何维持并发的正确性？](https://www.mianshiya.com/question/1780933295282876417)
- [550. 为什么 G1 垃圾收集器不维护年轻代到老年代的记忆集？](https://www.mianshiya.com/question/1780933295278682114)
...
1. **减少对应用程序的影响**：写屏障会消耗应用程序的性能，因为写屏障是在引用赋值的时候执行的逻辑，而 logging 可以把写屏障要执行的一些逻辑搬运到后台线程执行，来减轻对应用程序的影响，提升性能。
2. **记录引用变更**：当对象的引用关系发生变化时，write barrier 会记录这些变化，以便垃圾收集器在增量回收时能够正确地处理对象之间的引用。
3. **维护垃圾收集器的数据结构**：write barrier 用于维护卡表或记忆集（如 G1 中的 Remembered Set），用于优化跨代引用和跨区域引用的追踪。
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333734382e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333734382e706e67_mianshiya.png)
...
- **Shenandoah 和 ZGC**：这两种垃圾收集器也是基于并发的，write barrier 用于保持对象引用的正确性，确保垃圾收集和应用线程能够同时运行。在这些垃圾收集器中，write barrier 是**并发回收阶段**不可或缺的机制。
...
G1 从大局上看分为两大阶段，分别是**并发标记**和**对象拷贝**。
...
- 通过 `-XX:G1NewSizePercent=<percentage>` 和 `-XX:G1MaxNewSizePercent=<percentage>` 设置年轻代的最小和最大占比，控制新生代的大小，影响年轻代的回收频率和效率。
...
所以**年轻代的 region 都在收集范围内，因此不需要额外记录年轻代到老年代的跨代引用**。
...
- 在这个阶段，CMS 会进行一个快速的初始标记，标记所有根对象（如栈中的引用）**直接可达**的对象。此过程是 STW的，但时间较短。
...
3. **设置触发阈值**：通过`-XX:CMSInitiatingOccupancyFraction`设置老年代的触发阈值，提前触发CMS以减少停顿时间。
4. **使用并行GC**：结合`-XX:+UseParNewGC`使用并行年轻代收集器，以提升吞吐量。
...
- **`-XX:+UseCMSInitiatingOccupancyOnly`**：仅根据`CMSInitiatingOccupancyFraction`进行CMS回收，不在其它情况下触发。
...
![68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333733372e706e67.png](./img/小米虫宝典-基础面试篇-img/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79657373696d6964612f63646e5f696d6167652f696d672f32303232303132333136333733372e706e67_mianshiya.png)

##### 增量更新进一步理解

**增量更新**则是指在并发处理过程中，垃圾收集器可以分阶段、逐步更新对象的状态或引用信息，而不是在某个时刻一次性处理所有对象。
