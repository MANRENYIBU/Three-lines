...
![Linux 之父](./img/计算机操作系统-img/linux-father.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](./img/计算机操作系统-img/Linux-Logo.png)

### 常见的 Linux 发行版本

![Linux 操作系统](./img/计算机操作系统-img/linux.png)
...
![文件inode信息](./img/计算机操作系统-img/文件inode信息-DGIIRYlI.png)
...
![Linux的目录结构](./img/计算机操作系统-img/Linux目录树-DzjzZEII.png)
...
![ Linux 命令快查](./img/计算机操作系统-img/linux-command-search.png)

另外，[shell.how](https://www.shell.how/) 这个网站可以用来解释常见命令的意思，对你学习 Linux 基本命令以及其他常用命令（如 Git、NPM）。

![shell.how 使用示例](./img/计算机操作系统-img/shell-now.png)
...
![img](./img/计算机操作系统-img/Linux权限解读-BGnXOuG0.png)
